...
esg1p <- terra::vect("C:\\Users\\TRAVAH\\Documents\\GIS\\EcoFarm\\XutagOndor\\XutagOndor1pESGs.shp")
esg2p <- terra::vect("C:\\Users\\TRAVAH\\Documents\\GIS\\EcoFarm\\XutagOndor\\XutagOndor2pESGs.shp")
esg3p <- terra::vect("C:\\Users\\TRAVAH\\Documents\\GIS\\EcoFarm\\XutagOndor\\XutagOndor3pESGs.shp")
esg4p <- terra::vect("C:\\Users\\TRAVAH\\Documents\\GIS\\EcoFarm\\XutagOndor\\XutagOndor4pESGs.shp")
esg5p <- terra::vect("C:\\Users\\TRAVAH\\Documents\\GIS\\EcoFarm\\XutagOndor\\XutagOndor5pESGs.shp")


# Read in rasters
C0to5 <- raster::raster("C:\\Users\\TRAVAH\\Documents\\GIS\\EcoFarm\\C0to5XutagOndor.tif")
C5to15 <- raster::raster("C:\\Users\\TRAVAH\\Documents\\GIS\\EcoFarm\\C5to15XutagOndor.tif")
C15to30 <- raster::raster("C:\\Users\\TRAVAH\\Documents\\GIS\\EcoFarm\\C15to30XutagOndor.tif")

n0to5 <- raster::raster("C:\\Users\\TRAVAH\\Documents\\GIS\\EcoFarm\\n0to5XutagOndor.tif")
n5to15 <- raster::raster("C:\\Users\\TRAVAH\\Documents\\GIS\\EcoFarm\\n5to15XutagOndor.tif")
n15to30 <- raster::raster("C:\\Users\\TRAVAH\\Documents\\GIS\\EcoFarm\\n15to30XutagOndor.tif")

ph0to5 <- raster::raster("C:\\Users\\TRAVAH\\Documents\\GIS\\EcoFarm\\ph0to5XutagOndor.tif")
ph5to15 <- raster::raster("C:\\Users\\TRAVAH\\Documents\\GIS\\EcoFarm\\ph5to15XutagOndor.tif")
ph15to30 <- raster::raster("C:\\Users\\TRAVAH\\Documents\\GIS\\EcoFarm\\ph15to30XutagOndor.tif")

soc0to30 <- raster::raster("C:\\Users\\TRAVAH\\Documents\\GIS\\EcoFarm\\soc0to30XutagOndor.tif")
...
SOCmean <- SOCmean %>%
  ...
  dplyr::mutate(Bagh = "Bagh 1p",
                ...
                'Soil depth' = "0-30 cm") %>%
  dplyr::select(Bagh, ESG = Name_ENG, Property, 'Soil depth', Unit, Mean = SOC0to30XutagOndor) 
SOCstd <- SOCstd %>%
  as.data.frame() %>%
  dplyr::select(ESG = Name_ENG, 'Standard deviation' = SOC0to30XutagOndor) %>%
...
bp <- XutagOndor0to30 %>%
  ...
  geom_boxplot() + 
  ggtitle("Mean soil organic carbon stocks across ESGs, Xutag-Ondor soum, Bulgan") +
...
ggsave(plot = bp, filename = "C:\\Users\\TRAVAH\\Desktop\\Soil Carbon Mongolia\\EcoFarm\\XutagOndorBoxplot.png", width = 7, height = 4)


# Change ESG names
unique(XutagOndor0to30$ESG)
XutagOndor0to30 <- dplyr::mutate(XutagOndor0to30, ESG = ifelse(ESG == "1. Festuca-Forbs mountain steppe rangeland in Gravelly hills  and fan ESG, Forest steppe\r\n", 
...
XutagOndor0to30 <- XutagOndor0to30 %>%
  dplyr::mutate(Aimag = "Bulgan", Soum = "Xutag-Ondor") %>%
  dplyr::select(Aimag, Soum, Bagh:`Standard deviation`)


# Write to csv
write.csv(XutagOndor0to30, "C:\\Users\\TRAVAH\\Desktop\\Soil Carbon Mongolia\\EcoFarm\\XutagOndor0to30recalc.csv", row.names = FALSE)


# Faceted ESG barplot
XutagOndor0to30$ESG <- stringr::str_remove(XutagOndor0to30$ESG, "\\.[^.]*$")

barplot <- XutagOndor0to30 %>%
  dplyr::filter(Property == "Soil organic carbon stocks") %>%
  ggplot(aes(x = ESG, y = Mean, fill = ESG)) +
  geom_bar(stat = "identity") + 
  ggtitle("Mean soil organic carbon stocks across ESGs and Baghs, Xutag-Ondor soum, Bulgan aimag") +
  theme(legend.position = "none",
...
ggsave(plot = barplot, filename = "C:\\Users\\TRAVAH\\Desktop\\Soil Carbon Mongolia\\EcoFarm\\XutagOndorBarplot.png", width = 8, height = 6)
...
tab <- tab_header(tab, title = md("**ESG areas by bagh, Xutag-Ondor soum, Bulgan aimag**"))


tab


gt::gtsave(tab, path = "C:\\Users\\TRAVAH\\Desktop\\Soil Carbon Mongolia\\EcoFarm\\", filename = "XutagOndorAreaTable.png", vwidth = 1700, vheight = 1000)


write.csv(areas,  "C:\\Users\\TRAVAH\\Desktop\\Soil Carbon Mongolia\\EcoFarm\\XutagOndorAreaData.csv", row.names = FALSE)
